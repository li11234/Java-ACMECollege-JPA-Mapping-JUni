...
@MappedSuperclass //TODO PB01 - Add annotation to define this class as superclass of all entities.  Please see Week 9 lecture slides.
@Access(AccessType.FIELD) //TODO PB02 - Add annotation to place all JPA annotations on fields.
@EntityListeners({PojoListener.class}) //TODO PB03 - Add annotation for listener class.
